...
const PERMISSIONS = [
  ...
  { action: 'create', subject: 'Subscription', description: 'Souscrire un abonnement' },
  { action: 'read', subject: 'Subscription', description: 'Voir son abonnement' },
  { action: 'update', subject: 'Subscription', description: 'Modifier son abonnement' },
  { action: 'manage', subject: 'Subscription', description: 'Gerer tous les abonnements' },
